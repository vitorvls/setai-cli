/**
 * Anthropic Provider - Implementação do provedor Anthropic (Claude)
 */
...
/**
 * Classe para interagir com a API da Anthropic
 */
export class AnthropicProvider {
   ...
   */
  static async create(): Promise<AnthropicProvider | null> {
