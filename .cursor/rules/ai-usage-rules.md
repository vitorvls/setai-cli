...
- Usar modelos: Claude 4.5 Opus, GPT-5.2
...
- Usar modelos: Cursor + GPT-5.1 Codex, Gemini 3 Flash
...
### Ideação & Arquitetura
- **Claude 4.5 Opus** - Raciocínio profundo, visão sistêmica

### Planejamento Técnico
- **GPT-5.2** - Estrutura, consistência e padrões

### Implementação
- **Cursor Composer + GPT-5.1 Codex** - Contexto + execução

### Refatoração & Legado
- **Claude 4.5 Sonnet** - Leitura crítica e cautela

### Debug & Análise
- **Gemini 3 Pro** - Análise de grandes contextos

### Código Rápido / Boilerplate
- **Gemini 3 Flash** - Velocidade
